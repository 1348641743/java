...
static unsigned int sqlctx = 152403;
...
{12,4130,852,0,0,
5,0,0,1,75,0,4,5092,0,0,3,2,0,1,0,2,3,0,0,1,97,0,0,1,97,0,0,
};
...
namespace
{
 CDzczxx zczxx;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2637 "crtmzhye.pc"

 char FRDM_ZCZXX[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2639 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2641 "crtmzhye.pc"
...
namespace
{
 CDdzkgx dzkgx;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2755 "crtmzhye.pc"

 char FRDM_DZKGX[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2757 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2759 "crtmzhye.pc"
...
namespace
{
 CDdkhzx dkhzx;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2941 "crtmzhye.pc"

 char FRDM_DKHZX[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2943 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2945 "crtmzhye.pc"
...
namespace
{
 CDdkzdz dkzdz;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 3079 "crtmzhye.pc"

 char FRDM_DKZDZ[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 3081 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 3083 "crtmzhye.pc"
...
namespace
{
 CDzczjt zczjt;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 3354 "crtmzhye.pc"

 char FRDM_ZCZJT[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 3356 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 3358 "crtmzhye.pc"
...
namespace
{
 CDzczll zczll;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 3551 "crtmzhye.pc"

 char FRDM_ZCZLL[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 3553 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 3555 "crtmzhye.pc"
...
namespace
{
 CDzczpz zczpz;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 3675 "crtmzhye.pc"

 char FRDM_ZCZPZ[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 3677 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 3679 "crtmzhye.pc"
...
namespace
{
 CDmzhye mzhye;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 3939 "crtmzhye.pc"

 char FRDM_MZHYE[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 3941 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 3943 "crtmzhye.pc"
...
namespace
{
 CDzzhmx zzhmx;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4106 "crtmzhye.pc"

 char FRDM_ZZHMX[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 4108 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4110 "crtmzhye.pc"
...
namespace
{
 CDdkaxx dkaxx;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4364 "crtmzhye.pc"

 char FRDM_DKAXX[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 4366 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4368 "crtmzhye.pc"
...
namespace
{
 CDdkpzf dkpzf;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4533 "crtmzhye.pc"

 char FRDM_DKPZF[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 4535 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4537 "crtmzhye.pc"
...
namespace
{
 CDdpzdj dpzdj;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4795 "crtmzhye.pc"

 char FRDM_DPZDJ[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 4797 "crtmzhye.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4799 "crtmzhye.pc"
...
namespace
{
 CDzczbc zczbc;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 5014 "crtmzhye.pc"

 char FRDM_ZCZBC[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 5016 "crtmzhye.pc"
...
int main(int argc, char **argv)
{
 ...
 char sFormat2[10];
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 5059 "crtmzhye.pc"

  char sZHKHJG[9 +1]="";
   char sFRDM_U[4 +1]="";
  long inum = 0;
 /* EXEC SQL END DECLARE SECTION; */ 
#line 5063 "crtmzhye.pc"
