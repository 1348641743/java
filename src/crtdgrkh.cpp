...
static unsigned int sqlctx = 150155;
...
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2218 "crtdgrkh.pc"

typedef struct _TBL_DGRKH
{
  char frdm_u[4 +1];
  char khbh_u[12 +1];
  char zjzl_u[2 +1];
...
typedef struct _TBL_DGRKH TBL_DGRKH;
/* EXEC SQL END DECLARE SECTION; */ 
#line 2333 "crtdgrkh.pc"

typedef struct _DGRKH_UPDFLAG
{
 int FRDM_U_FLAG;
 int KHBH_U_FLAG;
 int ZJZL_U_FLAG;
...
class CDdgrkh
{
 ...
 TBL_DGRKH preDGRKH;
 TBL_DGRKH pstDGRKH;
 TBL_DGRKH TBL_Array[100];
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2472 "crtdgrkh.pc"

  char dgrkh_FRDM_U[4 +1];
  char dgrkh_KHBH_U[12 +1];
  char dgrkh_ZJZL_U[2 +1];
  char dgrkh_ZJHM_U[32 +1];
  char dgrkh_GRMC_U[200 +1];
  char dgrkh_YWMC_U[200 +1];
  char dgrkh_YWPYX_[200 +1];
  char dgrkh_YWPYM_[200 +1];
  char dgrkh_CYM_UU[200 +1];
  char dgrkh_KHCYYM[200 +1];
  char dgrkh_CW_UUU[2 +1];
  char dgrkh_DZDM_U[2 +1];
  char dgrkh_GBDM_U[3 +1];
  char dgrkh_SDM_UU[6 +1];
  char dgrkh_SHIDM_[6 +1];
  char dgrkh_XDM_UU[6 +1];
  char dgrkh_MZ_UUU[2 +1];
  char dgrkh_XB_UUU[2 +1];
  char dgrkh_CSRQ_U[8 +1];
  char dgrkh_YYAN_U[2 +1];
  char dgrkh_ZJXY_U[2 +1];
  char dgrkh_HYZK_U[2 +1];
  char dgrkh_JKZK_U[1 +1];
  char dgrkh_XW_UUU[3 +1];
  char dgrkh_XL_UUU[2 +1];
  char dgrkh_ZYZG_U[3 +1];
  char dgrkh_ZHIY_U[5 +1];
  char dgrkh_ZWFL_U[3 +1];
  char dgrkh_ZC_UUU[2 +1];
  char dgrkh_CYZKDM[2 +1];
  char dgrkh_HYDM_U[7 +1];
  char dgrkh_ZZMM_U[2 +1];
  long dgrkh_ZNQK_U;
  long dgrkh_JTRK_U;
  long dgrkh_FDJTCY;
  char dgrkh_HJDZBH[32 +1];
  char dgrkh_JZDZBH[32 +1];
  char dgrkh_DWDZBH[32 +1];
  char dgrkh_TXDZBH[32 +1];
  char dgrkh_YJDZBH[32 +1];
  char dgrkh_YDDHBH[32 +1];
  char dgrkh_ZZDHBH[32 +1];
  char dgrkh_DWDHBH[32 +1];
  char dgrkh_DZYJBH[32 +1];
  char dgrkh_GZDWBH[32 +1];
  char dgrkh_SCGZSJ[8 +1];
  char dgrkh_ZJLXSJ[2 +1];
  char dgrkh_ZJLXFS[2 +1];
  char dgrkh_PHJSFS[2 +1];
  char dgrkh_SFJNJM[1 +1];
  char dgrkh_KHJMSX[1 +1];
  char dgrkh_NHBZ_U[1 +1];
  char dgrkh_SFYGBZ[1 +1];
  char dgrkh_SFCSZD[1 +1];
  char dgrkh_HBDH_U[2 +1];
  char dgrkh_SFKHCX[1 +1];
  char dgrkh_SFSMKH[1 +1];
  char dgrkh_SFDJBZ[1 +1];
  char dgrkh_SFSWBZ[1 +1];
  char dgrkh_SFHCBZ[1 +1];
  char dgrkh_YWFYJ_[1 +1];
  char dgrkh_KHSDBZ[1 +1];
  char dgrkh_KHQCBZ[1 +1];
  char dgrkh_HMDBZ_[1 +1];
  char dgrkh_HUIMDB[1 +1];
  char dgrkh_WGBZ_U[1 +1];
  char dgrkh_KHYXZT[2 +1];
  char dgrkh_KHZT_U[1 +1];
  char dgrkh_SHNXRQ[8 +1];
  char dgrkh_SCKHRQ[8 +1];
  char dgrkh_SCDKRQ[8 +1];
  char dgrkh_KHFWJB[1 +1];
  char dgrkh_KHJZXX[40 +1];
  char dgrkh_WWKTYW[20 +1];
  char dgrkh_KHXXLY[1 +1];
  char dgrkh_GSJG_U[9 +1];
  char dgrkh_ZBJG_U[9 +1];
  char dgrkh_ZBJLBH[10 +1];
  char dgrkh_XDJG_U[9 +1];
  char dgrkh_XDJLBH[10 +1];
  char dgrkh_YXJG_U[9 +1];
  char dgrkh_YXR_UU[10 +1];
  char dgrkh_BM_UUU[2 +1];
  char dgrkh_JGH_UU[9 +1];
  char dgrkh_SYBBH_[9 +1];
  char dgrkh_BZXX_U[200 +1];
  char dgrkh_BYBZ1_[1 +1];
  char dgrkh_BYBZ2_[1 +1];
  char dgrkh_BYZD4W[4 +1];
  char dgrkh_BYZD40[40 +1];
  char dgrkh_YLZD1_[50 +1];
  char dgrkh_BYZD1_[200 +1];
  char dgrkh_BYZD4_[120 +1];
  char dgrkh_SCJYR_[8 +1];
  char dgrkh_KHRQ_U[8 +1];
  long dgrkh_KHSJ_U;
  char dgrkh_KHGYLS[20 +1];
  char dgrkh_KHJG_U[9 +1];
  char dgrkh_KHGY_U[10 +1];
  char dgrkh_SQGY_U[10 +1];
  char dgrkh_FQQD_U[3 +1];
  char dgrkh_WHRQ_U[8 +1];
  long dgrkh_WHSJ_U;
  char dgrkh_WHGYLS[20 +1];
  char dgrkh_WHJG_U[9 +1];
  char dgrkh_WHGY_U[10 +1];
  char dgrkh_WHSQGY[10 +1];
  char dgrkh_WHQD_U[3 +1];
  long dgrkh_SJC_UU;
  char dgrkh_JLZT_U[1 +1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2583 "crtdgrkh.pc"

 struct _DGRKH_UPDFLAG DGRKH_UPDFLAG;
 public:
  int DBProc();
  int INITA();
  int ROUND(TBL_DGRKH *pstBuf);
  int OPENCURSOR();
  int FETCHCURSOR();
  int CLOSECURSOR();
  int PRINTSQL();
  ...
  void LOG();
  void TRIM();
  void TRIMS(TBL_DGRKH *stTbl);
  void LOGS(TBL_DGRKH *stTbl);
  void INITD(TBL_DGRKH *stmpTbl);
 private:
  int INS();
  int SEL1();
  int SEL1L();
...
namespace
{
 CDdgrkh dgrkh;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2628 "crtdgrkh.pc"

 char FRDM_DGRKH[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2630 "crtdgrkh.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2632 "crtdgrkh.pc"
...
namespace
{
 CDdzjxx dzjxx;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2851 "crtdgrkh.pc"

 char FRDM_DZJXX[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2853 "crtdgrkh.pc"
...
strcpy(stDGRKH.frdm_u,sFRDM_U);
sprintf(stDGRKH.khbh_u,"01%s%06d",sYYJG_U,j);
strcpy(stDGRKH.zjzl_u,"10");
strcpy(stDGRKH.zjhm_u,stDGRKH.khbh_u);
sprintf(stDGRKH.grmc_u, "%s",stDGRKH.khbh_u);
strcpy(stDGRKH.ywmc_u,"");
strcpy(stDGRKH.ywpyx_,"");
strcpy(stDGRKH.ywpym_,"");
strcpy(stDGRKH.cym_uu,"");
strcpy(stDGRKH.khcyym,"");
strcpy(stDGRKH.cw_uuu,"");
strcpy(stDGRKH.dzdm_u,"");
strcpy(stDGRKH.gbdm_u,"");
strcpy(stDGRKH.sdm_uu,"");
strcpy(stDGRKH.shidm_,"");
strcpy(stDGRKH.xdm_uu,"");
strcpy(stDGRKH.mz_uuu,"");
strcpy(stDGRKH.xb_uuu,"");
strcpy(stDGRKH.csrq_u,"");
strcpy(stDGRKH.yyan_u,"");
strcpy(stDGRKH.zjxy_u,"");
strcpy(stDGRKH.hyzk_u,"");
strcpy(stDGRKH.jkzk_u,"");
strcpy(stDGRKH.xw_uuu,"");
strcpy(stDGRKH.xl_uuu,"");
strcpy(stDGRKH.zyzg_u,"");
strcpy(stDGRKH.zhiy_u,"");
strcpy(stDGRKH.zwfl_u,"");
strcpy(stDGRKH.zc_uuu,"");
strcpy(stDGRKH.cyzkdm,"");
strcpy(stDGRKH.hydm_u,"");
strcpy(stDGRKH.zzmm_u,"");
stDGRKH.znqk_u = 0;
stDGRKH.jtrk_u = 0;
stDGRKH.fdjtcy = 0;
strcpy(stDGRKH.hjdzbh,"");
strcpy(stDGRKH.jzdzbh,"");
strcpy(stDGRKH.dwdzbh,"");
strcpy(stDGRKH.txdzbh,"");
strcpy(stDGRKH.yjdzbh,"");
strcpy(stDGRKH.yddhbh,"");
strcpy(stDGRKH.zzdhbh,"");
strcpy(stDGRKH.dwdhbh,"");
strcpy(stDGRKH.dzyjbh,"");
strcpy(stDGRKH.gzdwbh,"");
strcpy(stDGRKH.scgzsj,"");
strcpy(stDGRKH.zjlxsj,"");
strcpy(stDGRKH.zjlxfs,"");
strcpy(stDGRKH.phjsfs,"");
strcpy(stDGRKH.sfjnjm,"");
strcpy(stDGRKH.khjmsx,"");
strcpy(stDGRKH.nhbz_u,"");
strcpy(stDGRKH.sfygbz,"");
strcpy(stDGRKH.sfcszd,"");
strcpy(stDGRKH.hbdh_u,"");
strcpy(stDGRKH.sfkhcx,"");
strcpy(stDGRKH.sfsmkh,"");
strcpy(stDGRKH.sfdjbz,"");
strcpy(stDGRKH.sfswbz,"");
strcpy(stDGRKH.sfhcbz,"");
strcpy(stDGRKH.ywfyj_,"");
strcpy(stDGRKH.khsdbz,"");
strcpy(stDGRKH.khqcbz,"");
strcpy(stDGRKH.hmdbz_,"");
strcpy(stDGRKH.huimdb,"");
strcpy(stDGRKH.wgbz_u,"");
strcpy(stDGRKH.khyxzt,"");
strcpy(stDGRKH.khzt_u,"");
strcpy(stDGRKH.shnxrq,"");
strcpy(stDGRKH.sckhrq,"");
strcpy(stDGRKH.scdkrq,"");
strcpy(stDGRKH.khfwjb,"");
strcpy(stDGRKH.khjzxx,"");
strcpy(stDGRKH.wwktyw,"");
strcpy(stDGRKH.khxxly,"");
strcpy(stDGRKH.gsjg_u,"");
strcpy(stDGRKH.zbjg_u,"");
strcpy(stDGRKH.zbjlbh,"");
strcpy(stDGRKH.xdjg_u,"");
strcpy(stDGRKH.xdjlbh,"");
strcpy(stDGRKH.yxjg_u,"");
strcpy(stDGRKH.yxr_uu,"");
strcpy(stDGRKH.bm_uuu,"");
strcpy(stDGRKH.jgh_uu,"");
strcpy(stDGRKH.sybbh_,"");
strcpy(stDGRKH.bzxx_u,"");
strcpy(stDGRKH.bybz1_,"");
strcpy(stDGRKH.bybz2_,"");
strcpy(stDGRKH.byzd4w,"");
strcpy(stDGRKH.byzd40,"");
strcpy(stDGRKH.ylzd1_,"");
strcpy(stDGRKH.byzd1_,"");
strcpy(stDGRKH.byzd4_,"");
strcpy(stDGRKH.scjyr_,"");
strcpy(stDGRKH.khrq_u,"");
stDGRKH.khsj_u = 0 ;
strcpy(stDGRKH.khgyls,"");
strcpy(stDGRKH.khjg_u,"");
strcpy(stDGRKH.khgy_u,"");
strcpy(stDGRKH.sqgy_u,"");
strcpy(stDGRKH.fqqd_u,"");
strcpy(stDGRKH.whrq_u,"");
stDGRKH.whsj_u = 0;
strcpy(stDGRKH.whgyls,"");
strcpy(stDGRKH.whjg_u,"");
strcpy(stDGRKH.whgy_u,"");
strcpy(stDGRKH.whsqgy,"");
strcpy(stDGRKH.whqd_u,"");
stDGRKH.sjc_uu = 0;
strcpy(stDGRKH.jlzt_u,"0");
strcpy(stDZJXX.frdm_u,sFRDM_U);
strcpy(stDZJXX.khbh_u,stDGRKH.khbh_u);
strcpy(stDZJXX.khlx_u,"01");
strcpy(stDZJXX.khzwm_,stDGRKH.grmc_u);
strcpy(stDZJXX.zjzl_u,stDGRKH.zjzl_u);
strcpy(stDZJXX.zjzlms,"Éí·ÝÖ¤");
strcpy(stDZJXX.zmwjbh,stDGRKH.zjhm_u);
