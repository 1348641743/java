...
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2218 "crtdgskh.pc"

typedef struct _TBL_DGSKH
{
  char frdm_u[4 +1];
  char khbh_u[12 +1];
  char zmwjzl[2 +1];
...
typedef struct _TBL_DGSKH TBL_DGSKH;
/* EXEC SQL END DECLARE SECTION; */ 
#line 2376 "crtdgskh.pc"

typedef struct _DGSKH_UPDFLAG
{
 int FRDM_U_FLAG;
 int KHBH_U_FLAG;
 int ZMWJZL_FLAG;
...
class CDdgskh
{
 ...
 TBL_DGSKH preDGSKH;
 TBL_DGSKH pstDGSKH;
 TBL_DGSKH TBL_Array[100];
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2558 "crtdgskh.pc"

  char dgskh_FRDM_U[4 +1];
  char dgskh_KHBH_U[12 +1];
  char dgskh_ZMWJZL[2 +1];
  char dgskh_ZMWJBH[32 +1];
  char dgskh_KHZWM_[200 +1];
  char dgskh_YWMC_U[200 +1];
  char dgskh_KHJM_U[50 +1];
  char dgskh_KHJP_U[20 +1];
  char dgskh_CYM_UU[200 +1];
  char dgskh_KHCYYM[200 +1];
  char dgskh_DZDM_U[2 +1];
  char dgskh_GBDM_U[3 +1];
  char dgskh_SDM_UU[6 +1];
  char dgskh_SHIDM_[6 +1];
  char dgskh_XDM_UU[6 +1];
  char dgskh_CLRQ_U[8 +1];
  char dgskh_KSRQ_U[8 +1];
  char dgskh_JSRQ_U[8 +1];
  char dgskh_NJRQ_U[8 +1];
  char dgskh_ZCZJBZ[2 +1];
  double dgskh_ZCZJ_U;
  double dgskh_SSZB_U;
  char dgskh_PZJGBH[12 +1];
  char dgskh_ZGBMH_[12 +1];
  char dgskh_SFRKHH[12 +1];
  char dgskh_KGGDKH[12 +1];
  char dgskh_FRDBKH[12 +1];
  char dgskh_DSZKHH[12 +1];
  char dgskh_JSZKHH[12 +1];
  char dgskh_DMKHH_[12 +1];
  char dgskh_ZJLKHH[12 +1];
  char dgskh_CWZKHH[12 +1];
  char dgskh_ZCDZBH[32 +1];
  char dgskh_ZCYWDZ[32 +1];
  char dgskh_YYDZBH[32 +1];
  char dgskh_YYYWDZ[32 +1];
  char dgskh_BGDHBH[32 +1];
  char dgskh_CZDHBH[32 +1];
  char dgskh_CWDHBH[32 +1];
  char dgskh_DZYJBH[32 +1];
  char dgskh_SYZLX_[3 +1];
  char dgskh_ZUZXZ_[4 +1];
  char dgskh_HYDM_U[7 +1];
  char dgskh_ZXQYHY[7 +1];
  char dgskh_QYLS_U[2 +1];
  char dgskh_FRBZ_U[1 +1];
  char dgskh_KJZZLX[1 +1];
  char dgskh_SJBZ_U[1 +1];
  char dgskh_SJYJ_U[1 +1];
  char dgskh_NSRGM_[1 +1];
  char dgskh_NSQK_U[2 +1];
  char dgskh_QYGMSB[2 +1];
  char dgskh_QYGMRH[2 +1];
  char dgskh_QYGMHN[2 +1];
  char dgskh_JYCDSY[2 +1];
  double dgskh_JYCDMJ;
  long dgskh_QYRS_U;
  double dgskh_XSE_UU;
  char dgskh_JYFS_U[1 +1];
  char dgskh_JYZT3_[2 +1];
  char dgskh_HNKHBZ[1 +1];
  char dgskh_JTKHBZ[1 +1];
  char dgskh_JTSXBZ[1 +1];
  char dgskh_JCKQBZ[1 +1];
  char dgskh_SSQYBZ[1 +1];
  char dgskh_YQHZBZ[1 +1];
  char dgskh_HBDBBZ[1 +1];
  char dgskh_ZZGKHB[1 +1];
  char dgskh_SMFRBZ[1 +1];
  char dgskh_KHJGLX[6 +1];
  char dgskh_KHZDLX[2 +1];
  char dgskh_KHLB_U[5 +1];
  char dgskh_JIGLX_[4 +1];
  char dgskh_QYGM_U[1 +1];
  char dgskh_ZCGM_U[1 +1];
  char dgskh_YGGM_U[1 +1];
  char dgskh_JKGM_U[1 +1];
  char dgskh_CKGM_U[1 +1];
  char dgskh_NXSGM_[1 +1];
  char dgskh_DWMYJY[1 +1];
  char dgskh_QYWGDM[6 +1];
  char dgskh_SZSBBS[1 +1];
  char dgskh_TSJJQL[2 +1];
  char dgskh_QYSX_U[2 +1];
  char dgskh_ISO900[1 +1];
  char dgskh_ISO140[1 +1];
  char dgskh_JSSP_U[1 +1];
  char dgskh_GMJJBM[3 +1];
  char dgskh_TSJJLX[2 +1];
  char dgskh_KHBCHY[2 +1];
  char dgskh_CYJGTZ[4 +1];
  char dgskh_SFGYZX[1 +1];
  char dgskh_ZLXXCY[4 +1];
  char dgskh_GTLQY_[1 +1];
  char dgskh_SFGLDW[1 +1];
  char dgskh_GXBS_U[1 +1];
  char dgskh_SFCSZD[1 +1];
  char dgskh_HBDH_U[2 +1];
  char dgskh_SFKHCX[1 +1];
  char dgskh_SFSMKH[1 +1];
  char dgskh_SFDJBZ[1 +1];
  char dgskh_SFSWBZ[1 +1];
  char dgskh_SFHCBZ[1 +1];
  char dgskh_YWFYJ_[1 +1];
  char dgskh_KHSDBZ[1 +1];
  char dgskh_KHQCBZ[1 +1];
  char dgskh_HMDBZ_[1 +1];
  char dgskh_HUIMDB[1 +1];
  char dgskh_WGBZ_U[1 +1];
  char dgskh_KHYXZT[2 +1];
  char dgskh_KHZT_U[1 +1];
  char dgskh_SHNXRQ[8 +1];
  char dgskh_SCKHRQ[8 +1];
  char dgskh_SCDKRQ[8 +1];
  char dgskh_KHFWJB[1 +1];
  char dgskh_KHJZXX[40 +1];
  char dgskh_WWKTYW[20 +1];
  char dgskh_KHXXLY[1 +1];
  char dgskh_GSJG_U[9 +1];
  char dgskh_ZBJG_U[9 +1];
  char dgskh_ZBJLBH[10 +1];
  char dgskh_XDJG_U[9 +1];
  char dgskh_XDJLBH[10 +1];
  char dgskh_YXJG_U[9 +1];
  char dgskh_YXR_UU[10 +1];
  char dgskh_BM_UUU[2 +1];
  char dgskh_JGH_UU[9 +1];
  char dgskh_SYBBH_[9 +1];
  char dgskh_BZXX_U[200 +1];
  char dgskh_BYBZ1_[1 +1];
  char dgskh_BYBZ2_[1 +1];
  char dgskh_BYZD4W[4 +1];
  char dgskh_BYZD40[40 +1];
  char dgskh_YLZD1_[50 +1];
  char dgskh_BYZD1_[200 +1];
  char dgskh_BYZD4_[120 +1];
  char dgskh_SCJYR_[8 +1];
  char dgskh_KHRQ_U[8 +1];
  long dgskh_KHSJ_U;
  char dgskh_KHGYLS[20 +1];
  char dgskh_KHJG_U[9 +1];
  char dgskh_KHGY_U[10 +1];
  char dgskh_SQGY_U[10 +1];
  char dgskh_FQQD_U[3 +1];
  char dgskh_WHRQ_U[8 +1];
  long dgskh_WHSJ_U;
  char dgskh_WHGYLS[20 +1];
  char dgskh_WHJG_U[9 +1];
  char dgskh_WHGY_U[10 +1];
  char dgskh_WHSQGY[10 +1];
  char dgskh_WHQD_U[3 +1];
  long dgskh_SJC_UU;
  char dgskh_JLZT_U[1 +1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2712 "crtdgskh.pc"

 struct _DGSKH_UPDFLAG DGSKH_UPDFLAG;
 public:
  int DBProc();
  int INITA();
  int ROUND(TBL_DGSKH *pstBuf);
  int OPENCURSOR();
  int FETCHCURSOR();
  int CLOSECURSOR();
  int PRINTSQL();
  ...
  void LOG();
  void TRIM();
  void TRIMS(TBL_DGSKH *stTbl);
  void LOGS(TBL_DGSKH *stTbl);
  void INITD(TBL_DGSKH *stmpTbl);
 private:
  int INS();
  int SEL1();
  int SEL1L();
...
namespace
{
 CDdgskh dgskh;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2757 "crtdgskh.pc"

 char FRDM_DGSKH[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2759 "crtdgskh.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2761 "crtdgskh.pc"
...
namespace
{
 CDdzjxx dzjxx;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2980 "crtdgskh.pc"

 char FRDM_DZJXX[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2982 "crtdgskh.pc"

};
int printDGSKH(TBL_DGSKH stDGSKH, char *sYYJG_U);
int main(int argc, char *argv[])
{
 ...
 printf("sFRDM_U is [%s], sYYJG_U is [%s]\n", sFRDM_U, sYYJG_U);
    for ( i = 0; i < atol(argv[3]); i++ )
    {
     ...
     strcpy(stDGSKH.frdm_u,sFRDM_U);
sprintf(stDGSKH.khbh_u, "02%s%06d",sYYJG_U,j);
strcpy(stDGSKH.zmwjzl,"21");
strcpy(stDGSKH.zmwjbh,stDGSKH.khbh_u);
sprintf(stDGSKH.khzwm_,"%s",stDGSKH.khbh_u);
strcpy(stDGSKH.ywmc_u,"");
strcpy(stDGSKH.khjm_u,"");
strcpy(stDGSKH.khjp_u,"");
strcpy(stDGSKH.cym_uu,"");
strcpy(stDGSKH.khcyym,"");
strcpy(stDGSKH.dzdm_u,"");
strcpy(stDGSKH.gbdm_u,"");
strcpy(stDGSKH.sdm_uu,"");
strcpy(stDGSKH.shidm_,"");
strcpy(stDGSKH.xdm_uu,"");
strcpy(stDGSKH.clrq_u,"");
strcpy(stDGSKH.ksrq_u,"");
strcpy(stDGSKH.jsrq_u,"");
strcpy(stDGSKH.njrq_u,"");
strcpy(stDGSKH.zczjbz,"");
stDGSKH.zczj_u = 0;
stDGSKH.sszb_u = 0;
strcpy(stDGSKH.pzjgbh,"");
strcpy(stDGSKH.zgbmh_,"");
strcpy(stDGSKH.sfrkhh,"");
strcpy(stDGSKH.kggdkh,"");
strcpy(stDGSKH.frdbkh,"");
strcpy(stDGSKH.dszkhh,"");
strcpy(stDGSKH.jszkhh,"");
strcpy(stDGSKH.dmkhh_,"");
strcpy(stDGSKH.zjlkhh,"");
strcpy(stDGSKH.cwzkhh,"");
strcpy(stDGSKH.zcdzbh,"");
strcpy(stDGSKH.zcywdz,"");
strcpy(stDGSKH.yydzbh,"");
strcpy(stDGSKH.yyywdz,"");
strcpy(stDGSKH.bgdhbh,"");
strcpy(stDGSKH.czdhbh,"");
strcpy(stDGSKH.cwdhbh,"");
strcpy(stDGSKH.dzyjbh,"");
strcpy(stDGSKH.syzlx_,"");
strcpy(stDGSKH.zuzxz_,"");
strcpy(stDGSKH.hydm_u,"");
strcpy(stDGSKH.zxqyhy,"");
strcpy(stDGSKH.qyls_u,"");
strcpy(stDGSKH.frbz_u,"");
strcpy(stDGSKH.kjzzlx,"");
strcpy(stDGSKH.sjbz_u,"");
strcpy(stDGSKH.sjyj_u,"");
strcpy(stDGSKH.nsrgm_,"");
strcpy(stDGSKH.nsqk_u,"");
strcpy(stDGSKH.qygmsb,"");
strcpy(stDGSKH.qygmrh,"");
strcpy(stDGSKH.qygmhn,"");
strcpy(stDGSKH.jycdsy,"");
stDGSKH.jycdmj = 0;
stDGSKH.qyrs_u = 0;
stDGSKH.xse_uu = 0;
strcpy(stDGSKH.jyfs_u,"");
strcpy(stDGSKH.jyzt3_,"");
strcpy(stDGSKH.hnkhbz,"");
strcpy(stDGSKH.jtkhbz,"");
strcpy(stDGSKH.jtsxbz,"");
strcpy(stDGSKH.jckqbz,"");
strcpy(stDGSKH.ssqybz,"");
strcpy(stDGSKH.yqhzbz,"");
strcpy(stDGSKH.hbdbbz,"");
strcpy(stDGSKH.zzgkhb,"");
strcpy(stDGSKH.smfrbz,"");
strcpy(stDGSKH.khjglx,"");
strcpy(stDGSKH.khzdlx,"");
strcpy(stDGSKH.khlb_u,"");
strcpy(stDGSKH.jiglx_,"");
strcpy(stDGSKH.qygm_u,"");
strcpy(stDGSKH.zcgm_u,"");
strcpy(stDGSKH.yggm_u,"");
strcpy(stDGSKH.jkgm_u,"");
strcpy(stDGSKH.ckgm_u,"");
strcpy(stDGSKH.nxsgm_,"");
strcpy(stDGSKH.dwmyjy,"");
strcpy(stDGSKH.qywgdm,"");
strcpy(stDGSKH.szsbbs,"");
strcpy(stDGSKH.tsjjql,"");
strcpy(stDGSKH.qysx_u,"");
strcpy(stDGSKH.iso900,"");
strcpy(stDGSKH.iso140,"");
strcpy(stDGSKH.jssp_u,"");
strcpy(stDGSKH.gmjjbm,"");
strcpy(stDGSKH.tsjjlx,"");
strcpy(stDGSKH.khbchy,"");
strcpy(stDGSKH.cyjgtz,"");
strcpy(stDGSKH.sfgyzx,"");
strcpy(stDGSKH.zlxxcy,"");
strcpy(stDGSKH.gtlqy_,"");
strcpy(stDGSKH.sfgldw,"");
strcpy(stDGSKH.gxbs_u,"");
strcpy(stDGSKH.sfcszd,"");
strcpy(stDGSKH.hbdh_u,"");
strcpy(stDGSKH.sfkhcx,"");
strcpy(stDGSKH.sfsmkh,"");
strcpy(stDGSKH.sfdjbz,"");
strcpy(stDGSKH.sfswbz,"");
strcpy(stDGSKH.sfhcbz,"");
strcpy(stDGSKH.ywfyj_,"");
strcpy(stDGSKH.khsdbz,"");
strcpy(stDGSKH.khqcbz,"");
strcpy(stDGSKH.hmdbz_,"");
strcpy(stDGSKH.huimdb,"");
strcpy(stDGSKH.wgbz_u,"");
strcpy(stDGSKH.khyxzt,"");
strcpy(stDGSKH.khzt_u,"");
strcpy(stDGSKH.shnxrq,"");
strcpy(stDGSKH.sckhrq,"");
strcpy(stDGSKH.scdkrq,"");
strcpy(stDGSKH.khfwjb,"");
strcpy(stDGSKH.khjzxx,"");
strcpy(stDGSKH.wwktyw,"");
strcpy(stDGSKH.khxxly,"");
strcpy(stDGSKH.gsjg_u,"");
strcpy(stDGSKH.zbjg_u,"");
strcpy(stDGSKH.zbjlbh,"");
strcpy(stDGSKH.xdjg_u,"");
strcpy(stDGSKH.xdjlbh,"");
strcpy(stDGSKH.yxjg_u,"");
strcpy(stDGSKH.yxr_uu,"");
strcpy(stDGSKH.bm_uuu,"");
strcpy(stDGSKH.jgh_uu,"");
strcpy(stDGSKH.sybbh_,"");
strcpy(stDGSKH.bzxx_u,"");
strcpy(stDGSKH.bybz1_,"");
strcpy(stDGSKH.bybz2_,"");
strcpy(stDGSKH.byzd4w,"");
strcpy(stDGSKH.byzd40,"");
strcpy(stDGSKH.ylzd1_,"");
strcpy(stDGSKH.byzd1_,"");
strcpy(stDGSKH.byzd4_,"");
strcpy(stDGSKH.scjyr_,"");
strcpy(stDGSKH.khrq_u,"");
stDGSKH.khsj_u = 0;
strcpy(stDGSKH.khgyls,"");
strcpy(stDGSKH.khjg_u,"");
strcpy(stDGSKH.khgy_u,"");
strcpy(stDGSKH.sqgy_u,"");
strcpy(stDGSKH.fqqd_u,"");
strcpy(stDGSKH.whrq_u,"");
stDGSKH.whsj_u = 0;
strcpy(stDGSKH.whgyls,"");
strcpy(stDGSKH.whjg_u,"");
strcpy(stDGSKH.whgy_u,"");
strcpy(stDGSKH.whsqgy,"");
strcpy(stDGSKH.whqd_u,"");
stDGSKH.sjc_uu = 0;
strcpy(stDGSKH.jlzt_u,"0");
strcpy(stDZJXX.frdm_u,sFRDM_U);
strcpy(stDZJXX.khbh_u,stDGSKH.khbh_u);
strcpy(stDZJXX.khlx_u,"02");
strcpy(stDZJXX.khzwm_,stDGSKH.khzwm_);
strcpy(stDZJXX.zjzl_u,stDGSKH.zmwjzl);
strcpy(stDZJXX.zjzlms,"组织机构代码");
strcpy(stDZJXX.zmwjbh,stDGSKH.zmwjbh);
