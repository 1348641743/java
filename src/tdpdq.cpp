...
static unsigned int sqlctx = 19811;
...
{12,4130,852,0,0,
5,0,0,1,75,0,4,5490,0,0,3,2,0,1,0,2,3,0,0,1,97,0,0,1,97,0,0,
};
...
typedef struct _TBL_ZCZDQ TBL_ZCZDQ;
/* EXEC SQL END DECLARE SECTION; */ 
#line 4231 "tdpdq.pc"

typedef struct _ZCZDQ_UPDFLAG
{
 int FRDM_U_FLAG;
 int FZZH_U_FLAG;
 int ZHKHJG_FLAG;
...
class CDzczdq
{
 ...
 TBL_ZCZDQ preZCZDQ;
 TBL_ZCZDQ pstZCZDQ;
 TBL_ZCZDQ TBL_Array[100];
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4281 "tdpdq.pc"

  char zczdq_FRDM_U[4 +1];
  char zczdq_FZZH_U[50 +1];
  char zczdq_ZHKHJG[9 +1];
  char zczdq_ZHDQR_[8 +1];
  long zczdq_JJRCL_;
  char zczdq_SFGJCK[1 +1];
  char zczdq_BJDQXX[1 +1];
  char zczdq_BZRZH_[50 +1];
  char zczdq_BJZRZH[50 +1];
  char zczdq_LXDQXX[1 +1];
  char zczdq_LXZRKH[50 +1];
  char zczdq_LXZRZH[50 +1];
  char zczdq_DQKXQ_[6 +1];
  char zczdq_CLZT_U[1 +1];
  char zczdq_SFBZ_U[1 +1];
  char zczdq_WHGY_U[10 +1];
  char zczdq_WHJG_U[9 +1];
  char zczdq_WHRQ_U[8 +1];
  long zczdq_WHSJ_U;
  long zczdq_SJC_UU;
  char zczdq_JILZT_[1 +1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 4303 "tdpdq.pc"

 struct _ZCZDQ_UPDFLAG ZCZDQ_UPDFLAG;
 public:
  int DBProc();
  int INITA();
  int ROUND(TBL_ZCZDQ *pstBuf);
  int OPENCURSOR();
  int FETCHCURSOR();
  int CLOSECURSOR();
  int PRINTSQL();
  ...
  void LOG();
  void TRIM();
  void TRIMS(TBL_ZCZDQ *stTbl);
  void LOGS(TBL_ZCZDQ *stTbl);
  void INITD(TBL_ZCZDQ *stmpTbl);
 private:
  int INS();
  int SEL1();
  int SEL1L();
...
typedef struct _TBL_ZCZXC TBL_ZCZXC;
/* EXEC SQL END DECLARE SECTION; */ 
#line 4372 "tdpdq.pc"

typedef struct _ZCZXC_UPDFLAG
{
 int FRDM_U_FLAG;
 int FZZH_U_FLAG;
 int ZHKHJG_FLAG;
...
class CDzczxc
{
 ...
 TBL_ZCZXC preZCZXC;
 TBL_ZCZXC pstZCZXC;
 TBL_ZCZXC TBL_Array[100];
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4420 "tdpdq.pc"

  char zczxc_FRDM_U[4 +1];
  char zczxc_FZZH_U[50 +1];
  char zczxc_ZHKHJG[9 +1];
  char zczxc_XCRQ_U[8 +1];
  char zczxc_XCPDH_[10 +1];
  char zczxc_XCCQ_U[6 +1];
  double zczxc_YDXCJE;
  long zczxc_BFXCLX;
  char zczxc_LTZRKH[50 +1];
  char zczxc_LTCRZH[50 +1];
  char zczxc_XCKXQ_[6 +1];
  char zczxc_LXTZFS[1 +1];
  char zczxc_CLZT_U[1 +1];
  char zczxc_WHGY_U[10 +1];
  char zczxc_WHJG_U[9 +1];
  char zczxc_WHRQ_U[8 +1];
  long zczxc_WHSJ_U;
  long zczxc_SJC_UU;
  char zczxc_JILZT_[1 +1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 4440 "tdpdq.pc"

 struct _ZCZXC_UPDFLAG ZCZXC_UPDFLAG;
 public:
  int DBProc();
  int INITA();
  int ROUND(TBL_ZCZXC *pstBuf);
  int OPENCURSOR();
  int FETCHCURSOR();
  int CLOSECURSOR();
  int PRINTSQL();
  ...
  void LOG();
  void TRIM();
  void TRIMS(TBL_ZCZXC *stTbl);
  void LOGS(TBL_ZCZXC *stTbl);
  void INITD(TBL_ZCZXC *stmpTbl);
 private:
  int INS();
  int SEL1();
  int SEL1L();
...
typedef struct _TBL_ZCZZK TBL_ZCZZK;
/* EXEC SQL END DECLARE SECTION; */ 
#line 4519 "tdpdq.pc"

typedef struct _ZCZZK_UPDFLAG
{
 int FRDM_U_FLAG;
 int FZZH_U_FLAG;
 int KZFNGS_FLAG;
...
class CDzczzk
{
 ...
 TBL_ZCZZK preZCZZK;
 TBL_ZCZZK pstZCZZK;
 TBL_ZCZZK TBL_Array[100];
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4577 "tdpdq.pc"

  char zczzk_FRDM_U[4 +1];
  char zczzk_FZZH_U[50 +1];
  char zczzk_KZFNGS[1 +1];
  char zczzk_SFZZZQ[1 +1];
  long zczzk_KZFF_U;
  char zczzk_ZDYKZF[5 +1];
  long zczzk_CSMFCS;
  char zczzk_KZZQCS[1 +1];
  long zczzk_MFCS_U;
  long zczzk_MFCSHF;
  long zczzk_ZDMFHF;
  long zczzk_ZQZJLY;
  char zczzk_LSBQBZ[1 +1];
  long zczzk_SFJLXS;
  long zczzk_ZCZQLX;
  long zczzk_FDYNZQ;
  char zczzk_CHFALX[1 +1];
  long zczzk_CFFF_U;
  char zczzk_DYZQJH[1 +1];
  char zczzk_ZQJEKZ[1 +1];
  double zczzk_ZQZDJE;
  char zczzk_LLBH_U[10 +1];
  char zczzk_JZLLCQ[6 +1];
  char zczzk_WHGY_U[10 +1];
  char zczzk_WHJG_U[9 +1];
  char zczzk_WHRQ_U[8 +1];
  long zczzk_WHSJ_U;
  long zczzk_SJC_UU;
  char zczzk_JILZT_[1 +1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 4607 "tdpdq.pc"

 struct _ZCZZK_UPDFLAG ZCZZK_UPDFLAG;
 public:
  int DBProc();
  int INITA();
  int ROUND(TBL_ZCZZK *pstBuf);
  int OPENCURSOR();
  int FETCHCURSOR();
  int CLOSECURSOR();
  int PRINTSQL();
  ...
  void LOG();
  void TRIM();
  void TRIMS(TBL_ZCZZK *stTbl);
  void LOGS(TBL_ZCZZK *stTbl);
  void INITD(TBL_ZCZZK *stmpTbl);
 private:
  int INS();
  int SEL1();
  int SEL1L();
...
typedef struct _TBL_ZCZZM TBL_ZCZZM;
/* EXEC SQL END DECLARE SECTION; */ 
#line 4675 "tdpdq.pc"

typedef struct _ZCZZM_UPDFLAG
{
 int FRDM_U_FLAG;
 int FZZH_U_FLAG;
 int KZQSRQ_FLAG;
...
class CDzczzm
{
 ...
 TBL_ZCZZM preZCZZM;
 TBL_ZCZZM pstZCZZM;
 TBL_ZCZZM TBL_Array[100];
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4722 "tdpdq.pc"

  char zczzm_FRDM_U[4 +1];
  char zczzm_FZZH_U[50 +1];
  char zczzm_KZQSRQ[8 +1];
  char zczzm_KZZZRQ[8 +1];
  long zczzm_FZKZLX;
  double zczzm_GDZQJE;
  long zczzm_KZCS_U;
  double zczzm_ZDZQJE;
  double zczzm_JEZL_U;
  double zczzm_ZGZQJE;
  char zczzm_CHFALX[1 +1];
  long zczzm_CFFF_U;
  char zczzm_WHGY_U[10 +1];
  char zczzm_WHJG_U[9 +1];
  char zczzm_WHRQ_U[8 +1];
  long zczzm_WHSJ_U;
  long zczzm_SJC_UU;
  char zczzm_JILZT_[1 +1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 4741 "tdpdq.pc"

 struct _ZCZZM_UPDFLAG ZCZZM_UPDFLAG;
 public:
  int DBProc();
  int INITA();
  int ROUND(TBL_ZCZZM *pstBuf);
  int OPENCURSOR();
  int FETCHCURSOR();
  int CLOSECURSOR();
  int PRINTSQL();
  ...
  void LOG();
  void TRIM();
  void TRIMS(TBL_ZCZZM *stTbl);
  void LOGS(TBL_ZCZZM *stTbl);
  void INITD(TBL_ZCZZM *stmpTbl);
 private:
  int INS();
  int SEL1();
  int SEL1L();
...
typedef struct _TBL_DKZXH TBL_DKZXH;
/* EXEC SQL END DECLARE SECTION; */ 
#line 4800 "tdpdq.pc"

typedef struct _DKZXH_UPDFLAG
{
 int FRDM_U_FLAG;
 int KHZHDM_FLAG;
 int DQWYXH_FLAG;
...
class CDdkzxh
{
 ...
 TBL_DKZXH preDKZXH;
 TBL_DKZXH pstDKZXH;
 TBL_DKZXH TBL_Array[100];
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 4838 "tdpdq.pc"

  char dkzxh_FRDM_U[4 +1];
  char dkzxh_KHZHDM[50 +1];
  long dkzxh_DQWYXH;
  char dkzxh_WHGY_U[10 +1];
  char dkzxh_WHJG_U[9 +1];
  char dkzxh_WHRQ_U[8 +1];
  long dkzxh_WHSJ_U;
  long dkzxh_SJC_UU;
  char dkzxh_JILZT_[1 +1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 4848 "tdpdq.pc"

 struct _DKZXH_UPDFLAG DKZXH_UPDFLAG;
 public:
  int DBProc();
  int INITA();
  int ROUND(TBL_DKZXH *pstBuf);
  int OPENCURSOR();
  int FETCHCURSOR();
  int CLOSECURSOR();
  int PRINTSQL();
  ...
  void LOG();
  void TRIM();
  void TRIMS(TBL_DKZXH *stTbl);
  void LOGS(TBL_DKZXH *stTbl);
  void INITD(TBL_DKZXH *stmpTbl);
 private:
  int INS();
  int SEL1();
  int SEL1L();
...
#line 5335 "tdpdq.pc"
 ...
 memset(sMonth, 0, 3);
 memset(sDay, 0, 3);
 strcpy(sZHKHR_,"20160324");
 strcpy(sJYRQ_U,"20160324");
...
#line 5490 "tdpdq.pc"
 ...
 for(i = 0; i<atol(argv[3]); i++)
 {
  ...
  printDZKGX(stDZKGX,sZHKHJG);
   ...
   strcpy(stZCZJT.fzzh_u, sFZZH_U);
   strcpy(stZCZJT.zhkhjg, sZHKHJG);
   strcpy(stZCZJT.lixdh_, "DQLX_U");
   strcpy(stZCZJT.jxfs_u, "0");
   strcpy(stZCZJT.jxyebz, "0");
   strcpy(stZCZJT.sfjxbz, "1");
   strcpy(stZCZJT.lldh_u, "DQLXLL");
   strcpy(stZCZJT.qixr_u, sQIXR_U);
   strcpy(stZCZJT.xcjtr1, "");
   stZCZJT.zxjxye = 0;
   stZCZJT.zdjxye = 0;
   stZCZJT.zhjtfs = 0;
   strcpy(stZCZJT.bzjtff, "10");
   strcpy(stZCZJT.sfjs_u, "1");
   stZCZJT.srjtye = 0;
   strcpy(stZCZJT.xyqsrq, "");
   strcpy(stZCZJT.zjgxrq, sQIXR_U);
    strcpy(stZCZJT.fxywdh, sFXYWDH);
   stZCZJT.fyeclf = 3;
   strcpy(stZCZJT.fxpl_u, "");
