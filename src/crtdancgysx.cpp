...
static unsigned int sqlctx = 1198059;
...
namespace
{
 CDcgysx cgysx;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2464 "crtdancgysx.pc"

 char FRDM_CGYSX[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2466 "crtdancgysx.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2468 "crtdancgysx.pc"
...
namespace
{
 CDdwxkz dwxkz;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2609 "crtdancgysx.pc"

 char FRDM_DWXKZ[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2611 "crtdancgysx.pc"

};
/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2613 "crtdancgysx.pc"
...
namespace
{
 CDzxjye zxjye;
 /* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 2792 "crtdancgysx.pc"

 char FRDM_ZXJYE[4 + 1];
 /* EXEC SQL END DECLARE SECTION; */ 
#line 2794 "crtdancgysx.pc"
